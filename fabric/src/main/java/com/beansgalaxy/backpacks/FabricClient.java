...
public class FabricClient implements ClientModInitializer {
      ...
      public void onInitializeClient() {
            ...
            EntityModelLayerRegistry.registerModelLayer(RenderHelper.PACK_CAPE_MODEL, BackpackCapeModel::createBodyLayer);
            ...
            ColorProviderRegistry.ITEM.register((stack, layer) -> layer == 1 ? 16777215 :
                        DyableBackpack.shiftBundleColor(((DyableBackpack) stack.getItem()).getBundleColor(stack)).getRGB(), FabricMain.BACK_BUNDLE);
